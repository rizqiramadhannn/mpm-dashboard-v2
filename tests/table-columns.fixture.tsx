...
const row: LedgerRow = { aging: "-", customerName: "Customer", feeAmount: 0, gpAmount: 100, gpPercent: "50%", hppAmount: 100, invoiceDate: "14/09/2026", invoiceDateRaw: "2026-09-14", invoiceId: null, invoiceNo: "INV001", kodAmount: 0, modalAmount: 100, ongkirAmount: 0, paidAmount: 0, paymentDate: "-", paymentDueDate: "-", paymentProofFiles: [], paymentTerm: "CBD", sphId: "sph1", sphNo: "SPH001", items, status: "BELUM BAYAR", statusClassName: "belum-bayar", ttdMateraiFile: null, totalAmount: 200 };
function Fixture() {
  ...
  return <TablePreferencesProvider scope={account} initialPreferences={initialPreferences}>
    <div className="main-content-body"><TableSorter />
      ...
      <InvoiceLedgerTable rows={[row]} canUpdatePaidAmount={false} updateLedgerAmountAction={async () => {}} />
    </div>
